...
function Footer() {
  return (
    <div className="flex gap-5 w-full rounded-2xl h-screen bg-zinc-100 p-20"
    >
      <div className='w-1/2 h-full flex flex-col justify-between font-["Founders Grotesk X-Cond"] text-black'>
        <div className="heading text-black">
          <h1 className="text-[6.5vw] font-bold tracking-tighter uppercase leading-none">
            Eye-
          </h1>
          <h1 className="text-[6.5vw] font-bold tracking-tighter uppercase leading-none">
            Opening
      ...
      <div className="w-1/2 text-black">
        ...
        <div className="textstructure py-10 px-5 relative z-10">
          {["S:", "‎ ", "Facebook", "Instagram", "Behance", "Linkedin"].map(
            (item, index) => (
              <div key={index} className="masker">
                <h1 className="text text-xl tracking-tighter text-black font-['Neue Montereal']">
                  {item}
                </h1>
              </div>
            )
        ...
        <div className="textstructure py-10 px-5 relative z-10">
          {["S:", "‎ ", "WALL STREET", "APART 40 AREA 51", "NEVADA USA"].map(
            (item, index) => (
              <div key={index} className="masker">
                <h1 className="text text-xl tracking-tighter text-black font-['Neue Montereal']">
                  {item}
